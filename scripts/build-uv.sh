...
if ! command -v pnpm &> /dev/null; then
    ...
    print_error "Visit https://pnpm.io/install or run:"
    print_error "  npm install -g pnpm"
    exit 1
fi

print_success "Node.js and pnpm are available"
...
echo "PYTHONPATH=${PROJECT_ROOT}/libs/python/core:${PROJECT_ROOT}/libs/python/computer:${PROJECT_ROOT}/libs/python/agent:${PROJECT_ROOT}/libs/python/som:${PROJECT_ROOT}/libs/python/pylume:${PROJECT_ROOT}/libs/python/computer-server:${PROJECT_ROOT}/libs/python/mcp-server:${PROJECT_ROOT}/libs/python/playground-api" > .env
